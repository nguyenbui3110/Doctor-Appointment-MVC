...
public class RemindAppointmentJob : IJob
{
    ...
    public RemindAppointmentJob(IAppointmentRepo appointmentRepo, IEmailSender emailSender, IMailTemplateHelper mailTemplateHelper, ILogger<RemindAppointmentJob> logger)
    {
